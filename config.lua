					...
					orderhall = {
						...
						args = {
							...
							hideAllTalents = {
								...
								type = "toggle",
								width = "full",
								name = L["Hide all talents"],
								desc = L["Don't display any talent information"],
								get = function() return configDb.general.orderhall.hideAllTalents end,
								set = function(_,v) configDb.general.orderhall.hideAllTalents = v
								Garrison:Update()
								end,
							},
							hideInactiveTalents = {
